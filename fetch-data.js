        ...
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            async function fetchUserData() {
                ...
                try {
                    // Use a custom parameter to bypass cache for demo purposes
                    const cacheBuster = new Date().getTime();
                    const response = await fetch(`${apiUrl}?cache=${cacheBuster}`);
            ...
            errorBtn.addEventListener('click', () => {
                ...
                setTimeout(async () => {
                    try {
                        ...
                        if (!response.ok) {
                            throw new Error('Simulated error: Invalid endpoint');
                        }
                    } catch (error) {
                        showError();
                    }
